...
module tb_pll_25mhz_configured_wrapper;
    ...
    task check_hard_macro_inputs;
        ...
        begin
            ...
            if (dut.hard_macro.DLF_KI !== expected_ki)
                $fatal(1, "%0s hard macro DLF_KI mismatch: got %0d expected %0d",
                       label, dut.hard_macro.DLF_KI, expected_ki);
            if (dut.hard_macro.DLF_KP !== expected_kp)
                $fatal(1, "%0s hard macro DLF_KP mismatch: got %0d expected %0d",
                       label, dut.hard_macro.DLF_KP, expected_kp);
    ...
    initial begin
        ...
        check_hard_macro_inputs("reset", 1'b0, 1'b0, 16'd500, 8'd20,
                                6'd1, 8'd121, 8'd16, 5'd4, 1'b1);

        reset_n = 1'b1;
        load_and_track_divider(5'd4, 16'd100, 8'd4, 6'd20, 8'd93, 8'd16, 5'd4);
        load_and_track_divider(5'd10, 16'd250, 8'd10, 6'd6, 8'd234, 8'd16, 5'd4);
        load_and_track_divider(5'd12, 16'd300, 8'd12, 6'd4, 8'd90, 8'd16, 5'd4);
        load_and_track_divider(5'd16, 16'd400, 8'd16, 6'd2, 8'd76, 8'd16, 5'd4);
        load_and_track_divider(5'd20, 16'd500, 8'd20, 6'd1, 8'd121, 8'd16, 5'd4);

...
module tb_pll_25mhz_mode_controller;
    ...
    initial begin
        ...
        check_mode_outputs("reset", 16'd500, 8'd20, 6'd2, 8'd149, 8'd4, 5'd2, 1'b1);
        ...
        check_mode_outputs("disabled", 16'd500, 8'd20, 6'd2, 8'd149, 8'd4, 5'd2, 1'b1);

...
module tb_pll_25mhz_mode_config;
    ...
    initial begin
        check_divider(5'd4, 16'd100, 8'd4, 6'd20, 8'd93, 8'd16, 5'd4, 1'b1);
        check_divider(5'd10, 16'd250, 8'd10, 6'd6, 8'd234, 8'd16, 5'd4, 1'b1);
        check_divider(5'd12, 16'd300, 8'd12, 6'd4, 8'd90, 8'd16, 5'd4, 1'b1);
        check_divider(5'd16, 16'd400, 8'd16, 6'd2, 8'd76, 8'd16, 5'd4, 1'b1);
        check_divider(5'd20, 16'd500, 8'd20, 6'd1, 8'd121, 8'd16, 5'd4, 1'b1);

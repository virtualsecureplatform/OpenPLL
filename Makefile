...
xyce-pll-postlayout-dco-mixed-25mhz-500m-nearseed-low-smoke: xyce-pll-postlayout-dco-mixed-25mhz-500m-hold-smoke
...
spice-dco-postlayout-einvp-coarse-target-probe:
	...
	./scripts/spice_dco_postlayout.sh --simulator xyce --xyce "$(DCO_POSTLAYOUT_PVT_XYCE)" --xyce-mpi-procs "$(DCO_POSTLAYOUT_PVT_XYCE_MPI_PROCS)" --codes 0,128,255 --coarse-codes 1,0 --subckt-name IntegerPLL_DCO_EINVP_COARSE --rcx-netlist "$(DCO_EINVP_COARSE_POSTLAYOUT_SIGNOFF_RCX)" --sim-time-ns 50 --meas-start-ns 12 --step-ps 10 --timeout-s 900 --jobs 4 --resume --build-dir "$$(pwd)/build/spice_dco_postlayout_einvp_coarse90_drv4_nodeepslow0_450_600_probe_mpi4"
